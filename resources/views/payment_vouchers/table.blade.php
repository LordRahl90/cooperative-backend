        ...
        @foreach($paymentVouchers as $paymentVoucher)
            ...
            <td>{{ $paymentVoucher->pv_id }}</td>
                <td width="120">
                    ...
                    <div class='btn-group'>
                        <a href="{{ route('paymentVouchers.show', [$paymentVoucher->id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('paymentVouchers.edit', [$paymentVoucher->id]) }}" class='btn btn-default btn-xs'>
