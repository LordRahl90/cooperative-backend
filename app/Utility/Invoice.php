...
class Invoice extends Fpdf
{
    ...
    public static function welcome($str)
    {
        return "Welcome " . strtoupper($str);
    }
...
// public functions
    public function sizeOfText($texte, $largeur)
    {
        ...
        while ($loop) {
            ...
            Log::info("Res: " . $res . " Length: " . $length . " Large:" . $largeur . " Text: " . $texte);
            $nb_lines += $res;
        }
        return $nb_lines;
    }
...
// Company
    function addCompanyAddress($nom, $adresse)
    {
        $x1 = 10;
        $y1 = 8;
...
// Mode of payment
    function addReglement($mode)
    {
        ...
        $this->SetFont("Arial", "B", 10);
        $this->Cell(10, 4, "TOTAL AMOUNT (Naira)", 0, 0, "C");
...
// VAT number
    ...
    function addCols($tab)
    {
        ...
        $y2 = $this->h - 150 - $y1;
        $this->SetXY($r1, $y1);
        $this->RoundedRect($r1, $y1, $r2, $y2, 2.5, "D");
...
// add a line to the invoice/estimate
    ...
    */
    ...
    public function addCadreTVAs()
    {
        ...
        $y1 = $this->h - 100;
        $y2 = $y1 + 20;
        $this->RoundedRect($r1, $y1, ($r2 - $r1), (70), 2.5, 'D');
...
// call this method first
    public function watermark($texte)
    {
        $this->SetFont('Arial', 'B', 40);
        $this->SetTextColor(203, 203, 203);
        $this->Rotate(45, 45, 190);
        $this->Text(30, 300, $texte);
        $this->Text(100, 100, $texte);
        $this->Rotate(0);
